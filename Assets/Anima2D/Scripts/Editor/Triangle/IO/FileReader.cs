    ...
    public static class FileReader
    {
        ...
        public static InputGeometry ReadPolyFile(string polyfilename, bool readElements, bool readArea)
        {
            ...
            using (var reader = new StreamReader(polyfilename))
            {
                ...
                if (data.Points == null) throw new Exception("No nodes available.");
        ...
        private static List<ITriangle> ReadEleFile(string elefilename, bool readArea)
        {
            ...
            using (var reader = new StreamReader(elefilename))
            {
                ...
                if (attributes > 1) SimpleLog.Instance.Warning("Triangle attributes not supported.", "FileReader.Read");
        ...
        private static void ReadVertex(InputGeometry data, int index, string[] line, int attributes, int marks)
        {
            ...
            if (marks > 0 && line.Length > 3 + attributes) mark = int.Parse(line[3 + attributes]);
