...
namespace TriangleNet
{
    ...
    {
        private static double splitter; // Used to split double factors for exact multiplication.

        private static double epsilon; // Floating-point machine epsilon.
