...
namespace Anima2D
{
    ...
    {
        private PropertyInfo m_ActiveAnimationClipProperty;
        private PropertyInfo m_ActiveGameObjectProperty;
        private PropertyInfo m_ActiveRootGameObjectProperty;
        ...
        private FieldInfo m_AnimEditorField;
        protected Type m_AnimEditorType = typeof(EditorWindow).Assembly.GetType("UnityEditor.AnimEditor");
        private PropertyInfo m_CurrentTimeProperty;

        private PropertyInfo m_FrameProperty;
        private MethodInfo m_FrameToTimeMethod;

        private MethodInfo m_GetAllAnimationWindows;
        private PropertyInfo m_PlayingProperty;
        private PropertyInfo m_RecordingProperty;
        private PropertyInfo m_RefreshProperty;
        private FieldInfo m_StateField;
        private MethodInfo m_TimeToFrameMethod;

        private ScriptableObject animEditor
        {
            get
            {
        ...
        protected object state
        {
            get
            {
                if (animEditor && m_StateField != null) return m_StateField.GetValue(animEditor);
                return null;
            }
        }
        ...
        public virtual int frame
        {
            get
            {
                if (state != null && m_FrameProperty != null) return (int) m_FrameProperty.GetValue(state, null);
            ...
            set
            {
                if (state != null && m_FrameProperty != null) m_FrameProperty.SetValue(state, value, null);
            }
        }
        ...
        public virtual bool recording
        {
            ...
            set
            {
                if (state != null && m_RecordingProperty != null) m_RecordingProperty.SetValue(state, value, null);
            }
        }
        ...
        public int refresh
        {
            get
            {
                if (state != null && m_RefreshProperty != null) return (int) m_RefreshProperty.GetValue(state, null);
                return 0;
            }
        }
        ...
        public bool playing
        {
            get
            {
                if (state != null && m_PlayingProperty != null) return (bool) m_PlayingProperty.GetValue(state, null);
                return false;
            }
        }
