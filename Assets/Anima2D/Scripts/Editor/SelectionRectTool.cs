...
namespace Anima2D
{
    ...
    {
        private static Vector2 s_StartPosition = Vector2.zero;
        private static Vector2 s_EndPosition = Vector2.zero;
        private static Rect s_currentRect = new Rect(0f, 0f, 0f, 0f);
        ...
        public static Rect Do(int controlID)
        {
            ...
            if (eventType == EventType.Layout) HandleUtility.AddDefaultControl(controlID);
